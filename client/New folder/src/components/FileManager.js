...
function FileManager(props) {
    ...
    const [folders, setFolders] = useState([{ name: "NNN" }]);
    ...
    //const subFolder1 = localStorage.getItem("folderName");
    ...
    return (
        ...
        <div style={style2}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap" }}>
                    ...
                    <div>
                        <div key={id}>
                            <AuthContext.Provider value={{ folderName: folder.name }} >
                                ...
                                {/* <button type="button" onClick={this.handleRemoveFolder(id)} className="small">-</button> */}
                ...
                {/* <CreateNewFolderIcon style={style} onClick={handleClickOpen} /> */}
                <div >
